...
$string['enableforcourse'] = 'Enable for this course';
$string['enablepercourse'] = 'Enable per course';
$string['enablepercoursedescription'] = 'Should reminders be enabled globally, or per course';
...
$string['yesdefaulton'] = 'Yes, default enabled in all courses';
$string['yesdefaultoff'] = 'Yes, default not enabled in any course';
