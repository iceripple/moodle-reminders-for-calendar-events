...
if ($hassiteconfig) {
    ...
    $settings->add(new admin_setting_configcheckbox('local_reminders_percourse',
            get_string('enablepercourse', 'local_reminders'),
            get_string('enablepercoursedescription', 'local_reminders'), 1));
